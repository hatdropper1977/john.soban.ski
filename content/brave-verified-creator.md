...
![Brave Verified]({static}/images/Brave_Verified_Creator/00_Brave_Verified.png)
...
![Open the Installer]({static}/images/Brave_Verified_Creator/02_Open_Installer.png)

Click **Run**.

![Run the Installer]({static}/images/Brave_Verified_Creator/03_Run_Installer.png)

The Installer provides status through the installation.

It first phones home to the Brave download repository.

![The Installed Connects]({static}/images/Brave_Verified_Creator/04_Install_Connect.png)

The Installer then downloads the binary.

![The Installer Downloads]({static}/images/Brave_Verified_Creator/05_Install_Download.png)

It checks your Operating System.

![Wait for the Installer]({static}/images/Brave_Verified_Creator/06_Install_Wait.png)

The Installer then begins installation.

![Installation Commences]({static}/images/Brave_Verified_Creator/07_Install_Execute.png)

After the Installer completes, it launches the **Brave Browser**.

![Successfull installation]({static}/images/Brave_Verified_Creator/08_Install_Success.png)
...
![Import Chrome Bookmarks, Apps and History]({static}/images/Brave_Verified_Creator/09_Import_Chrome.png)
...
![Import all your Chrome Plugins]({static}/images/Brave_Verified_Creator/10_Plugin_Download.png)
...
![Select DuckDuckGo for Private Browsing]({static}/images/Brave_Verified_Creator/11_Select_Duckduckgo.png)
...
![Click Start Rewards]({static}/images/Brave_Verified_Creator/12_Start_Rewards.png)

Brave provides a wizard that explains how to earn rewards.  Either click through the tour or click **Skip.** 

![Take the tour Wizard]({static}/images/Brave_Verified_Creator/13_Take_Tour.png)

To register a wallet, click the [Basic Attention Token (BAT)](https://basicattentiontoken.org/) icon and then click **verify wallet**.

![Click the Basic Attention Token (BAT) Icon]({static}/images/Brave_Verified_Creator/14_Click_Icon.png)

Click **Continue**.

![Continue with Verification]({static}/images/Brave_Verified_Creator/15_Verify_Continue.png)
...
![Select Uphold for Brave Wallet]({static}/images/Brave_Verified_Creator/16_Click_Uphold.png)

Click **Authorize**.

![Click Authorize]({static}/images/Brave_Verified_Creator/17_Click_Authorize.png)

Click the green text that reads **Sign up now** and then fill out the web form.

![Sign Up]({static}/images/Brave_Verified_Creator/18_Sign_Up.png)
...
![Check you Email]({static}/images/Brave_Verified_Creator/19_Will_Redirect.png)

Find the **Uphold** email in your email client, open the email and then click **Verify**.

![Uphold Verification]({static}/images/Brave_Verified_Creator/20_Verify_Uphold.png)

**Uphold** provides another wizard to create the crypto wallet.

Fill out the required information and complete the wizard.

![A Wizard to Sign Up for Uphold]({static}/images/Brave_Verified_Creator/21_Verify_Wizard.png)
...
![Verify your phone number]({static}/images/Brave_Verified_Creator/22_Verify_Phone.png)

After you enter the MFA token, enter your home address.

![Enter your Home Address]({static}/images/Brave_Verified_Creator/23_Home_Address.png)

Uphold renders a success splash page and the option to connect external crypto wallets (Coinbase, Kraken, STEX).

Click **Let's do this**.

![Connect an External Wallet]({static}/images/Brave_Verified_Creator/24_Connect_External.png)

Answer and click through the required questions.

![First Question]({static}/images/Brave_Verified_Creator/25_Question_One.png)

Once Uphold returns the **Dashboard** screen, click **Verify your identity**.

![Click Verify ID]({static}/images/Brave_Verified_Creator/26_Click_Verifyid.png)
...
![Scan the QR Code]({static}/images/Brave_Verified_Creator/27_Scan_Qr.png)
...
![Send Code to Text]({static}/images/Brave_Verified_Creator/28_Use_Phone.png)
...
![Check your Email Again]({static}/images/Brave_Verified_Creator/29_Email_Again.png)

Enter a credit card to buy **BAT**, which allows you to tip other content creators.

![Enter your Credit Card]({static}/images/Brave_Verified_Creator/30_Enter_Credit.png)

Enter the desired amount of **BAT** and complete the purchase.

![Buy BAT]({static}/images/Brave_Verified_Creator/31_Buy_Bat.png)

Click the **BAT** logo.

![Click the BAT Logo]({static}/images/Brave_Verified_Creator/32_Click_Logo.png)

You will see a message that indicates that you connected a **Verified Wallet** to your brave browser.

![Your verified Wallet]({static}/images/Brave_Verified_Creator/33_Verified_Wallet.png)
...
![Enable Two Factor]({static}/images/Brave_Verified_Creator/34_Two_Factor.png)
...
![Brave Creators Splash Page]({static}/images/Brave_Verified_Creator/35_Creators_Brave.png)

You do not need to configure a password with this site, you authenticate via a link sent to your email address.

![No Password]({static}/images/Brave_Verified_Creator/36_No_Password.png)

Navigate to your email client once more, locate the **Brave Rewards Creators** email and then click **Verify email**.

![Check Your Email Again]({static}/images/Brave_Verified_Creator/37_Creator_Email.png)

Enter your name and click **Sign Up**.

![Enter Your Name]({static}/images/Brave_Verified_Creator/38_Creator_Name.png)

**Brave Rewards** lists the actions you need to take in order to complete the registration process.

Click **OK**.

![The Creator Signup Checklist]({static}/images/Brave_Verified_Creator/39_Creator_Checklist.png)

Pick your payout Crypto.  I selected **BAT**.

![Select BAT Payout]({static}/images/Brave_Verified_Creator/40_Select_Bat.png)

Now select the channel medium.  Since I have a [website](https://john.soban.ski) I select **Website**.

![Select Add Website]({static}/images/Brave_Verified_Creator/41_Add_Website.png)

Enter the domain name of the website you own.

![Enter Your Domain Name]({static}/images/Brave_Verified_Creator/42_Domain_Name.png)

Now download the **verification file**.

![Download the Verification File]({static}/images/Brave_Verified_Creator/43_Download_File.png)
...
![The Instructions for Verification]({static}/images/Brave_Verified_Creator/44_Verify_Instructions.png)

**Brave** verified my site within minutes.

After verification, my **publishers** page listed my new channel.

![Congratulations]({static}/images/Brave_Verified_Creator/45_Connect_Success.png)
